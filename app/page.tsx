            ...
            <Card>
              <CardHeader className="flex flex-row items-center gap-4">
                ...
                <div className="grid gap-1">
                  ...
                  <CardDescription>Content in Afrikaans, English, and Tswana</CardDescription>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-gray-500">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Our platform is designed to be simple and effective for nursery schools across South Africa.
              </p>
            </div>
          </div>
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 mt-12">
            <Card className="border-2">
              <CardHeader>
                ...
                <div className="mt-4 text-4xl font-bold">
                  R299<span className="text-sm font-normal text-gray-500">/month</span>
                </div>
              </CardHeader>
            ...
            <Card className="border-2 border-purple-600">
              <CardHeader>
                ...
                <div className="mt-4 text-4xl font-bold">
                  R499<span className="text-sm font-normal text-gray-500">/month</span>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-2 text-sm">
            ...
            <Card className="border-2">
              <CardHeader>
                ...
                <div className="mt-4 text-4xl font-bold">
                  R899<span className="text-sm font-normal text-gray-500">/month</span>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-2 text-sm">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-purple-100 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Join hundreds of nursery schools across South Africa already using our platform.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
        ...
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                <li className="text-gray-500">123 Education Street, Pretoria, South Africa</li>
                <li className="text-gray-500">info@edugrowa.co.za</li>
                <li className="text-gray-500">+27 (0) 12 345 6789</li>
              </ul>
            </div>
          </div>
